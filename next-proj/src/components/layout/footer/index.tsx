...
export default function Footer() {
  return (
    <footer className="bg-black text-white py-10 px-6 md:px-20">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-6">
        <div className="col-span-4">
          <h2 className="text-xl font-semibold flex items-center gap-2">
            <span className="inline-block"></span>Skateshop
          </h2>
        </div>
        <div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-6 mt-6">
        <div>
          <h3 className="text-md font-semibold">Credits</h3>
          <ul className="mt-2 space-y-1 text-gray-400">
            <li>OneStopShop</li>
            <li>Acme Corp</li>
            <li>craft.mxkaske.dev</li>
            <li>Taxonomy</li>
            <li>shadcn/ui</li>
          </ul>
        </div>
      ...
      <div className="max-w-6xl mx-auto mt-10 flex justify-between items-center">
        <p className="text-gray-400">Built by <span className="font-bold">Sadman.</span></p>
